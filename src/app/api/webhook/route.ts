...
export async function POST(req: NextRequest) {
  ...
  if (eventType === "call.session_started") {
    ...
    //Disha Changed the code he a lil bit here>>
    const call = streamVideo.video.call("default", meetingId);

// 👇 FORCE agent to join as a Stream user
await db
  .update(meetings)
  .set({
    status: "active",
...
console.log("🤖 Fake agent marked active:", existingAgent.name);





    //used open ai key here (og code commented below)
    // const call = streamVideo.video.call("default", meetingId);
